...
(deftest test-convert-to-ledger-format-with-paypal
  ...
  (is (= (convert-to-ledger-format myconf/recipient-to-moneycategory ["29.12.2021" "29.12.2021" "SEPA-Lastschrift von" "PayPal (Europe) S.a.r.l. et Cie., S.C.A." ". Spotify Limited, Ihr Einkauf bei Spotify Limited" "DE88500700102175526303" "DEUTDEFHXXX" "1017624592854  PAYPAL" "5QKJ223MTLWAL" "LU96ZZZ0000000000000000058" "" "" "" "" "" "-9,99" "" "EUR"])
...
(deftest test-convert-to-ledger-format-with-auftraggeber
  ...
  (is (= (convert-to-ledger-format myconf/recipient-to-moneycategory ["10.11.2021" "10.11.2021" "SEPA-Lastschrift von" "Drillisch Online GmbH" "C4413004 U440695502 B514217508 handyvertrag.de" "DE89506400151233322700" "COBADEFF506" "" "EF958053341760F03563C0DC35C" "DE40ZZZ10000206926" "" "" "" "" "" "-10,59" "" "EUR"])
