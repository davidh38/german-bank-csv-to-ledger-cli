...
(deftest test-convert-to-ledger-format-with-betreff
 (testing "FIXME, betreff")
  (is (= (convert-to-ledger-format myconf/test ["30.12.2021" "30.12.2021" "Kartenzahlung" "" "NETTO MARKEN-DISCOU//DUESSELDORF/DE 29-12-2021T21:34:38 Folgenr. 07 Verfalld. 1523"  "" "" "" "-20,20"  "EUR"])
...
(deftest test-convert-to-ledger-format-with-paypal
 (testing "FIXME, paypal")
  (is (= (convert-to-ledger-format myconf/test ["29.12.2021" "29.12.2021" "SEPA-Lastschrift von" "PayPal (Europe) S.a.r.l. et Cie., S.C.A." ". Spotify Limited, Ihr Einkauf bei Spotify Limited" "DE88500700102175526303" "DEUTDEFHXXX" "1017624592854  PAYPAL" "5QKJ223MTLWAL" "LU96ZZZ0000000000000000058" "" "" "" "" "" "-9,99" "" "EUR"])
...
(deftest test-convert-to-ledger-format-with-auftraggeber
 (testing "FIXME, aufftraggeber")
  (is (= (convert-to-ledger-format myconf/test ["10.11.2021" "10.11.2021" "SEPA-Lastschrift von" "Drillisch Online GmbH" "C4413004 U440695502 B514217508 handyvertrag.de" "DE89506400151233322700" "COBADEFF506" "" "EF958053341760F03563C0DC35C" "DE40ZZZ10000206926" "" "" "" "" "" "-10,59" "" "EUR"])
